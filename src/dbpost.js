...
new Article({ id: 1, author: 'sep1', img: null, date: new Date().getTime(), body: 'This is my first article'}).save()
new Article({ id: 2, author: 'sep1', img: null, date: new Date().getTime(), body: 'This is my second article'}).save()
new Article({ id: 3, author: 'jmg3', img: null, date: new Date().getTime(), body: "This is Max's article"}).save(function() {
